...
namespace zxingwp7.common
{
    ...
    public sealed class PerspectiveTransform
    {
        ...
        public static PerspectiveTransform squareToQuadrilateral(float x0, float y0, float x1, float y1, float x2,
                                                                 float y2, float x3, float y3)
        {
            ...
            else
            {
                ...
                return new PerspectiveTransform(x1 - x0 + a13*x1, x3 - x0 + a23*x3, x0, y1 - y0 + a13*y1,
        ...
        internal PerspectiveTransform buildAdjoint()
        {
            ...
            return new PerspectiveTransform(a22*a33 - a23*a32, a23*a31 - a21*a33, a21*a32 - a22*a31, a13*a32 - a12*a33,
