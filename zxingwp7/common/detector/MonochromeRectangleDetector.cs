...
namespace zxingwp7.common.detector
{
    ...
    public sealed class MonochromeRectangleDetector
    {
        ...
        private ResultPoint findCornerFromCenter(int centerX, int deltaX, int left, int right, int centerY, int deltaY,
                                                 int top, int bottom, int maxWhiteRun)
        {
            int[] lastRange = null;
                ...
                else
                {
                    ...
                    do
                    {
                        start--;
                             ...
                             !(horizontal
                                   ? image.get_Renamed(start, fixedDimension)
                                   : image.get_Renamed(fixedDimension, start)));
            ...
            while (end < maxDim)
            {
                ...
                else
                {
                    ...
                    do
                    {
                             ...
                             !(horizontal
                                   ? image.get_Renamed(end, fixedDimension)
                                   : image.get_Renamed(fixedDimension, end)));
