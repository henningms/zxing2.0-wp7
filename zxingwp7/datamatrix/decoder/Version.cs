...
namespace zxingwp7.datamatrix.decoder
{
    ...
    public sealed class Version
    {
        ...
        private Version(int versionNumber, int symbolSizeRows, int symbolSizeColumns, int dataRegionSizeRows,
            ...
            return new[]
                       {
                           ...
                           new Version(29, 16, 36, 10, 16, new ECBlocks(24, new ECB(1, 32))),
                           new Version(30, 16, 48, 14, 22, new ECBlocks(28,
                                                                        new ECB(1, 49)))
                       };
        }
