...
namespace zxingwp7.datamatrix.decoder
{
    ...
    internal sealed class BitMatrixParser
    {
        ...
        internal BitMatrixParser(BitMatrix bitMatrix)
        {
            ...
            readMappingMatrix = new BitMatrix(mappingBitMatrix.Dimension);
        }
        ...
        {
            var result = new sbyte[version.TotalCodewords];
            int resultOffset = 0;
        ...
        internal BitMatrix extractDataRegion(BitMatrix bitMatrix)
        {
            ...
            // TODO(bbrown): Make this work with rectangular codes
            var bitMatrixWithoutAlignment = new BitMatrix(sizeDataRegionRow);
