...
namespace zxingwp7.oned
{
    ...
    public sealed class ITFReader : OneDReader
    {
        ...
        private static readonly int[] DEFAULT_ALLOWED_LENGTHS = new[] {6, 10, 14, 44};
        ...
        private static readonly int[] START_PATTERN = new[] {N, N, N, N};


        private static readonly int[] END_PATTERN_REVERSED = new[] {N, N, W};

        /// <summary> Patterns of Wide / Narrow lines to indicate each digit</summary>

        private static readonly int[][] PATTERNS = new[]
                                                       {
                                                           new[] {N, N, W, W, N}, new[] {W, N, N, N, W},
                                                           new[] {N, W, N, N, W}, new[] {W, W, N, N, N},
                                                           new[] {N, N, W, N, W}, new[] {W, N, W, N, N},
                                                           new[] {N, W, W, N, N}, new[] {N, N, N, W, W},
                                                           new[] {W, N, N, W, N}, new[] {N, W, N, W, N}
                                                       };
