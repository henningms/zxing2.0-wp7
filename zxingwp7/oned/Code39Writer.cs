...
namespace zxingwp7.oned
{
    ...
    {
        public override ByteMatrix encode(string contents, BarcodeFormat format, int width, int height, Dictionary<EncodeHintType, Object> hints)
        {
        ...
        public override sbyte[] encode(string contents)
        {
            ...
            var result = new sbyte[codeWidth];
