...
namespace zxingwp7.qrcode.detector
{
    ...
    internal sealed class AlignmentPatternFinder
    {
        ...
        /// </param>
        internal AlignmentPatternFinder(BitMatrix image, int startX, int startY, int width, int height, float moduleSize,
                                        ResultPointCallback resultPointCallback)
        {
            this.image = image;
            possibleCenters = new List<ResultPoint>(5);
            this.startX = startX;
            this.startY = startY;
            this.width = width;
            this.height = height;
        ...
        private AlignmentPattern handlePossibleCenter(int[] stateCount, int i, int j)
        {
            ...
            if (!Single.IsNaN(centerI))
            {
                ...
                {
                    var center = (AlignmentPattern) possibleCenters[index];
