...
using Version = zxingwp7.qrcode.decoder.Version;
...
namespace zxingwp7.qrcode.detector
{
    ...
    public class Detector
    {
        ...
        public virtual PerspectiveTransform createTransform(ResultPoint topLeft, ResultPoint topRight,
                                                            ...
                                                            int dimension)
        {
            ...
            PerspectiveTransform transform = PerspectiveTransform.quadrilateralToQuadrilateral(3.5f, 3.5f, dimMinusThree,
                                                                                               3.5f, sourceBottomRightX,
                                                                                               sourceBottomRightY, 3.5f,
                                                                                               dimMinusThree, topLeft.X,
                                                                                               topLeft.Y, topRight.X,
                                                                                               topRight.Y, bottomRightX,
                                                                                               bottomRightY,
                                                                                               bottomLeft.X,
                                                                                               bottomLeft.Y);
        ...
        /// </summary>
        protected internal static int computeDimension(ResultPoint topLeft, ResultPoint topRight, ResultPoint bottomLeft,
                                                       float moduleSize)
        {
        ...
        private float calculateModuleSizeOneWay(ResultPoint pattern, ResultPoint otherPattern)
        {
            ...
            float moduleSizeEst1 = sizeOfBlackWhiteBlackRunBothWays((int) pattern.X, (int) pattern.Y,
                                                                    (int) otherPattern.X, (int) otherPattern.Y);

            float moduleSizeEst2 = sizeOfBlackWhiteBlackRunBothWays((int) otherPattern.X, (int) otherPattern.Y,
