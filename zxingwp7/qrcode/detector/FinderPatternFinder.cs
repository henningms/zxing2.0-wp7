...
namespace zxingwp7.qrcode.detector
{
    ...
    public class FinderPatternFinder
    {
        ...
        private readonly List<ResultPoint> possibleCenters;
        ...
        {
            this.image = image;
            possibleCenters = new List<ResultPoint>(10);
        ...
        protected internal virtual List<ResultPoint> PossibleCenters
        {
            get
            {
        ...
        internal virtual FinderPatternInfo find(Dictionary<DecodeHintType, Object> hints)
        {
        ...
        private float crossCheckVertical(int startI, int centerJ, int maxCount, int originalStateCountTotal)
        {
            ...
            return foundPatternCross(stateCount) ? centerFromEnd(stateCount, i) : Single.NaN;
        }
        ...
        private float crossCheckHorizontal(int startJ, int centerI, int maxCount, int originalStateCountTotal)
        {
            ...
            return foundPatternCross(stateCount) ? centerFromEnd(stateCount, j) : Single.NaN;
        }
        ...
        private int findRowSkip()
        {
            ...
            for (int i = 0; i < max; i++)
            {
                var center = (FinderPattern) possibleCenters[i];
        ...
        private FinderPattern[] selectBestPatterns()
        {
            ...
            if (possibleCenters.Count > 3)
            {
                ...
                possibleCenters.Sort(new CenterComparator());
                possibleCenters.Capacity = 3;
            }
        ...
        #region Nested type: CenterComparator

        /// <summary> <p>Orders by {@link FinderPattern#getCount()}, descending.</p></summary>
        private class CenterComparator : Comparer<ResultPoint>
        {
            public override int Compare(ResultPoint x, ResultPoint y)
            {
                return ((FinderPattern)x).Count - ((FinderPattern)(y)).Count;
            }
        }
