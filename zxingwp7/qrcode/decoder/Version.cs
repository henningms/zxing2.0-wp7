...
namespace zxingwp7.qrcode.decoder
{
            ...
            return new[]
                       {
                           ...
                           new Version(9, new[] {6, 26, 46}, new ECBlocks(30, new ECB(2, 116)),
                           ...
                           new Version(10, new[] {6, 28, 50}, new ECBlocks(18, new ECB(2, 68), new ECB(2, 69)),
                           ...
                           new Version(19, new[] {6, 30, 58, 86}, new ECBlocks(28, new ECB(3, 113), new ECB(4, 114)),
                           ...
                           new Version(23, new[] {6, 30, 54, 74, 102},
                           ...
                           new Version(35, new[] {6, 30, 54, 78, 102, 126, 150},
                                       ...
                                       new ECBlocks(30, new ECB(39, 24), new
                                                                             ECB(14, 25)),
