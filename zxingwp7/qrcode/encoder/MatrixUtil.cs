...
namespace zxingwp7.qrcode.encoder
{
    ...
    public sealed class MatrixUtil
    {
        ...
        private static readonly int[][] HORIZONTAL_SEPARATION_PATTERN = new[] {new[] {0, 0, 0, 0, 0, 0, 0, 0}};


        private static readonly int[][] VERTICAL_SEPARATION_PATTERN = new[]
                                                                          {
        ...
        private static readonly int[][] POSITION_ADJUSTMENT_PATTERN = new[]
                                                                          {
                                                                              new[] {1, 1, 1, 1, 1}, new[] {1, 0, 0, 0, 1},
                                                                              new[] {1, 0, 1, 0, 1}, new[] {1, 0, 0, 0, 1},
                                                                              new[] {1, 1, 1, 1, 1}
                                                                          };
        ...
        private static readonly int[][] TYPE_INFO_COORDINATES = new[]
                                                                    {
                                                                        ...
                                                                        new[] {8, 7}, new[] {8, 8}, new[] {7, 8},
                                                                        new[] {5, 8}, new[] {4, 8}, new[] {3, 8},
                                                                        new[] {2, 8}, new[] {1, 8}, new[] {0, 8}
                                                                    };
