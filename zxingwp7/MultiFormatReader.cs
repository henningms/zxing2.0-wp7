...
namespace zxingwp7
{
    ...
    public sealed class MultiFormatReader : Reader
    {
        ...
        /// </param>
        public Dictionary<DecodeHintType, Object> Hints
        {
            set
            {
                hints = value;
                ...
                List<BarcodeFormat> formats = value == null
                                                  ? null
                                                  : (List<BarcodeFormat>) value[DecodeHintType.POSSIBLE_FORMATS];
                readers = new List<Reader>(10);
                if (formats != null)
                {
                    bool addOneDReader = formats.Contains(BarcodeFormat.UPC_A) || formats.Contains(BarcodeFormat.UPC_E) ||
